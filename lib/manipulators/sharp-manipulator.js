...
(function() {
  ...
  SharpManipulator = (function() {
    ...
    SharpManipulator.prototype.manipulate = function(callback) {
      var calculated_width, degrees, height_ratio, image, percent_factor, region_width, width_ratio;
      ...
      if (this.params.size !== 'full') {
        if ((this.params.size.w != null) && (this.params.size.h != null)) {
          if (this.params.size.type === 'sizeByConfinedWh') {
            width_ratio = this.params.region.w / this.params.size.w;
            height_ratio = this.params.region.h / this.params.size.h;
