...
(function() {
  var ConvertManipulator, ExtractorJP2Kakadu, _, async, child_process, fs, tempfile,
  ...
  ExtractorJP2Kakadu = (function() {
    function ExtractorJP2Kakadu(options, final_callback) {
      ...
      this.final_image_path = tempfile("." + this.params.format);
    }
      ...
      return async.series([
        function(seriescb) {
          ...
          return function(seriescb) {
            var manipulator;
            manipulator = new ConvertManipulator(_this.temp_bmp, _this.params, _this.final_image_path, seriescb);
            return manipulator.manipulate();
          };
        })(this), (function(_this) {
          return function(seriescb) {
            seriescb();
            return _this.final_callback(_this.final_image_path);
          };
        })(this), (function(_this) {
          return function(seriescb) {
